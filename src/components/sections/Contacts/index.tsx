...
import { BackgroundGradient, ContactInfo, SessionOrderForm, Typography } from '../../ui';
...
const Contacts = () => {
  return (
    ...
    >
      <div className="space-y-12 pb-10 xl:pb-24 2xl:space-y-10">
        {/* Title */}
        <div>
          <Typography
            parentAs="h1"
        ...
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between sm:gap-0">
          ...
          <div className="order-2 mx-auto w-full max-w-[500px] sm:order-1 sm:mx-0 sm:w-[40%] sm:max-w-none lg:w-[37%] xl:w-[37%]">
            {/* Title */}
            <motion.div
              variants={staggerContainer(1.2, 0, 1)}
